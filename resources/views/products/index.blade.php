...
<main class="ml-[260px] p-margin-desktop max-w-[calc(1440px-260px)] min-h-screen">
  ...
  {{-- FILTERS + STATS --}}
  <form method="GET" action="{{ route('products.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-gutter mb-8">

    <div class="md:col-span-1 bg-surface-container-lowest p-5 rounded-xl border border-white/20">
    ...
    <div class="md:col-span-2 bg-surface-container-lowest p-5 rounded-xl border border-white/20 flex items-center">
      <div>
...
<x-pos.form-modal>
  <div class="space-y-4">
    ...
    <div>
      <label>Prix</label>
      <input type="number" name="price" placeholder="Prix d'unité..."
        :value="$store.crud.formData.price"
        @input="$store.crud.formData.price = $event.target.value"
        class="w-full border rounded-lg p-2">
    </div>
    ...
    <div>
      ...
      <input type="number" name="quantity_stock" placeholder="Quantité en stock..."
        :value="$store.crud.formData.quantity_stock"
        @input="$store.crud.formData.quantity_stock = $event.target.value"
        class="w-full border rounded-lg p-2">
    </div>
    ...
    <div>
      ...
      <select name="category_id"
        :value="$store.crud.formData.category_id"
        @change="$store.crud.formData.category_id = $event.target.value"
        class="w-full border rounded-lg p-2">
    ...
    <div>
      ...
      <select name="supplier_id"
        :value="$store.crud.formData.supplier_id"
        @change="$store.crud.formData.supplier_id = $event.target.value"
        class="w-full border rounded-lg p-2">
